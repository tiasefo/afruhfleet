...
Generated: Tue Jun  2 10:37:32 PM UTC 2026
...
|---|---|---|
| Billing / Credits | ✅ Exposed in AfruHeritage API | matched: billing|subscription|credits|wallet |
| Fleet / Vehicles | ✅ Exposed in AfruHeritage API | matched: vehicle|vehicles|fleetbase/vehicles |
| Customer Portal / Members | ✅ Exposed in AfruHeritage API | matched: members|users|customers |
| KYC / Vendor Verification | ✅ Exposed in AfruHeritage API | matched: kyc|documents|liveness|ocr |
| Dispatch / Jobs | ✅ Exposed in AfruHeritage API | matched: dispatch|jobs|booking|accept |
| AI Assistant | ✅ Exposed in AfruHeritage API | matched: ai/chat|ai/widget |
| Shipments / Orders | ✅ Exposed in AfruHeritage API | matched: shipment|shipments|orders |
| Domains / Tenant Portal | ✅ Exposed in AfruHeritage API | matched: domains|resolve|activate |
| Support / Tickets | ✅ Exposed in AfruHeritage API | matched: support|ticket |
| Runtime Provisioning | ✅ Exposed in AfruHeritage API | matched: fleetbase-runtime|provision-runtime|reconcile-runtime |
| GPS / Live Tracking | ✅ Exposed in AfruHeritage API | matched: gps|tracking|location|route |
| Marketplace / Vendors | ✅ Exposed in AfruHeritage API | matched: vendor|vendors|marketplace |
| CRM | ✅ Exposed in AfruHeritage API | matched: crm|contacts|quotes|opportunities |
| Drivers | ✅ Exposed in AfruHeritage API | matched: driver|drivers |
