...
export const metadata: Metadata = {
  title: "Privacy Policy | AMOOKSCO Logistics",
  description: "How AMOOKSCO Logistics collects, uses and protects your personal data.",
}
...
const sections = [
  ...
  },
  {
    ...
    body: [
      "We apply reasonable technical and organisational measures to protect your data. Tracking and customer records are held under tenant isolation on the AfruHeritage platform and accessible only to authorised AMOOKSCO staff.",
    ],
  },
  {
    title: "6. Your Rights",
