...
countries = {
    "ghana": {
        "name": "Ghana",
        "headline": "Ghana gateway for customs, air cargo, ocean freight, and last-mile delivery.",
        "video": "/assets/videos/airport-footage-panama-city-panama-ground-crew-unloading-cargo-shipment-from-airplane-on.webm",
        "theme": "Airport cargo operations",
    },
    "kenya": {
        "name": "Kenya",
        "headline": "Kenya logistics corridor for East Africa freight, customs, and fleet distribution.",
        "video": "/assets/videos/Truck20004964.mp4",
        "theme": "Fleet and inland distribution",
    },
    "nigeria": {
        "name": "Nigeria",
        "headline": "Nigeria trade route support for ocean freight, customs documentation, and cargo delivery.",
        "video": "/assets/videos/27427654-preview.mp4",
        "theme": "Port and commercial freight",
    },
    "china": {
        "name": "China",
        "headline": "China sourcing, export consolidation, supplier freight, and Africa-bound cargo movement.",
        "video": "/assets/videos/istockphoto-1473471897-640_adpp_is.mp4",
        "theme": "Export and supplier logistics",
    },
    "djibouti": {
        "name": "Djibouti",
        "headline": "Djibouti maritime gateway for Red Sea logistics, port clearance, and regional distribution.",
        "video": "/assets/videos/istockphoto-918314666-640_adpp_is.mp4",
        "theme": "Maritime gateway",
    },
    "somalia": {
        "name": "Somalia",
        "headline": "Somalia freight support for import coordination, documentation, and delivery movement.",
        "video": "/assets/videos/Vans-2220419522-640_adpp_is.mp4",
        "theme": "Regional delivery operations",
    },
}
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden bg-[#063f4f] text-white">
        ...
        <div className="absolute inset-0 bg-[#021f2a]/75" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#021f2a] via-[#063f4f]/80 to-transparent" />
...
for slug, data in countries.items():
    d = Path("frontend/app/locations") / slug
    d.mkdir(parents=True, exist_ok=True)
    (d / "page.tsx").write_text(template.format(**data))
    print("patched", d / "page.tsx")
