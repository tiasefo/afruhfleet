...
class Plan(Base):
    ...
    max_drivers: Mapped[int] = mapped_column(Integer, nullable=False, default=3)
    max_vehicles: Mapped[int] = mapped_column(Integer, nullable=False, default=3)
    max_shipments_per_month: Mapped[int] = mapped_column(Integer, nullable=False, default=50)
    max_products: Mapped[int] = mapped_column(Integer, nullable=False, default=10)
    max_group_members: Mapped[int] = mapped_column(Integer, nullable=False, default=100)
    # Feature flags per tier
    dispatch_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    route_planning_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    service_rates_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    pod_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    route_optimization_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    vrp_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    ...
    extensions_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    maintenance_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    fuel_tracking_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    csv_import_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
