...
export default function SouthAfricaCustomsPage() {
  return (
  <>
    <BackButton />
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 lg:px-8">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-6xl">
              AfruHeritage South Africa Customs & Freight Services
            </h1>

            <p className="mt-6 max-w-3xl text-lg text-white/85">
              South Africa freight and customs support page. Calculator support will be enabled after country rules are validated.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <Link href="/support" className="inline-flex items-center justify-center rounded-lg bg-white px-6 py-3 font-semibold text-[#063f4f] hover:bg-white/90">
