...
const features = [
  {
    ...
    description:
      'Estimate vehicle and cargo duties using ICUMS-style valuation logic, VIN decoding, tax base, levies, and BOE-calibrated fallback rules.',
    icon: ShieldCheck,
  },
  {
    title: 'Kenya KRA CRSP',
    description:
      'Estimate Kenyan vehicle duties using KRA CRSP-style valuation and country-specific import charges.',
    icon: Globe2,
  },
  {
    title: 'Vehicle VIN Lookup',
    description:
      'Start with a VIN, decode vehicle details, then continue into the customs duty workflow.',
    icon: Truck,
  },
  {
    title: 'Cargo & HS Code Duties',
    description:
      'Estimate cargo duties with CIF, HS code, quantity, weight, and customs charge breakdown.',
    icon: FileCheck2,
  },
]
        ...
        <section className="relative overflow-hidden bg-[#063f4f] text-white">
          <div className="absolute inset-0 opacity-30">
            <video autoPlay muted loop playsInline className="h-full w-full object-cover">
              <source
                src="/assets/videos/airport-footage-panama-city-panama-ground-crew-unloading-cargo-shipment-from-airplane-on.webm"
                type="video/webm"
              />
              <source
                src="/assets/videos/behistockphoto-531834958-640_adpp_is.mp4"
                type="video/mp4"
              />
            </video>
          </div>
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          <div className="max-w-3xl">
            <h2 className="text-3xl font-bold tracking-tight">
              Built for customs clearance operations
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
              Start with duty estimation, then connect the result to shipment creation,
              documentation, broker workflow, and customer clearance support.
            </p>
          </div>
          ...
          <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
            <div className="max-w-2xl">
              ...
              <h2 className="mt-6 text-4xl font-bold">
                See customs clearance in action at major ports.
              </h2>
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-2 lg:px-8">
            <div>
              ...
              <p className="mt-4 text-muted-foreground">
                The customs module is designed to become part of the larger Afruheritage freight
                platform: quote, document, clear, ship, and track from one place.
              </p>
