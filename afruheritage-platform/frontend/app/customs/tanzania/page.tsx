...
export default function TanzaniaCustomsPage() {
  return (
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 lg:px-8">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-6xl">
              AfruHeritage Tanzania Customs & Freight Services
            </h1>

            <p className="mt-6 max-w-3xl text-lg text-white/85">
              Tanzania customs and freight support page. Calculator support will be enabled after country rules are validated.
            </p>
