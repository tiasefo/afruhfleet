          ...
          <div className="relative container mx-auto px-4 py-20 h-full flex items-center">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-muted-foreground mb-6">
                West Africa's Largest Economy and Logistics Hub
              </p>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              Experience Our Nigeria Operations
            </h2>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-card p-6 rounded-lg border">
                <h3 className="text-xl font-semibold text-foreground mb-3">Lagos & Apapa Ports</h3>
                <p className="text-muted-foreground">
                  Nigeria's busiest ports handling the majority of West African maritime trade.
                </p>
              </div>
              <div className="bg-card p-6 rounded-lg border">
                <h3 className="text-xl font-semibold text-foreground mb-3">Economic Powerhouse</h3>
                <p className="text-muted-foreground">
                  Access to Africa's largest economy and biggest consumer market.
                </p>
              </div>
              <div className="bg-card p-6 rounded-lg border">
                <h3 className="text-xl font-semibold text-foreground mb-3">Extensive Network</h3>
                <p className="text-muted-foreground">
                  Comprehensive logistics network covering all major Nigerian cities.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Ship to/from Nigeria?
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Contact our Nigeria team today for personalized logistics solutions.
            </p>
