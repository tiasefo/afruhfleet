          ...
          <div className="relative container mx-auto px-4 py-20 h-full flex items-center">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-muted-foreground mb-6">
                Global Manufacturing Hub and Trade Partner
              </p>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              Experience Our China Operations
            </h2>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-card p-6 rounded-lg border">
                <h3 className="text-xl font-semibold text-foreground mb-3">Manufacturing Powerhouse</h3>
                <p className="text-muted-foreground">
                  Access to the world's largest manufacturing base and supplier network.
                </p>
              </div>
              <div className="bg-card p-6 rounded-lg border">
                <h3 className="text-xl font-semibold text-foreground mb-3">Major Ports</h3>
                <p className="text-muted-foreground">
                  Operations in Shanghai, Shenzhen, Guangzhou, and other key Chinese ports.
                </p>
              </div>
              <div className="bg-card p-6 rounded-lg border">
                <h3 className="text-xl font-semibold text-foreground mb-3">Africa-China Trade</h3>
                <p className="text-muted-foreground">
                  Specialized expertise in China-Africa trade routes and customs procedures.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Ship to/from China?
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Contact our China team today for personalized logistics solutions.
            </p>
