          ...
          <div className="relative container mx-auto px-4 py-20 h-full flex items-center">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-muted-foreground mb-6">
                Strategic Horn of Africa Logistics Gateway
              </p>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              Experience Our Somalia Operations
            </h2>
            <div className="max-w-4xl mx-auto">
              <div className="relative aspect-video bg-muted rounded-lg overflow-hidden">
                ...
                >
                  <source src="/Artifacts/airport-footage-panama-city-panama-ground-crew-unloading-cargo-shipment-from-airplane-on.webm" type="video/webm" />
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-card p-6 rounded-lg border">
                <h3 className="text-xl font-semibold text-foreground mb-3">Strategic Maritime Position</h3>
                <p className="text-muted-foreground">
                  Located along key shipping routes connecting Europe, Asia, and Africa.
                </p>
              </div>
              <div className="bg-card p-6 rounded-lg border">
                <h3 className="text-xl font-semibold text-foreground mb-3">Port of Mogadishu</h3>
                <p className="text-muted-foreground">
                  Modern port facilities with growing capacity for international trade.
                </p>
              </div>
              <div className="bg-card p-6 rounded-lg border">
                <h3 className="text-xl font-semibold text-foreground mb-3">Regional Trade Hub</h3>
                <p className="text-muted-foreground">
                  Gateway to East Africa and the broader Horn of Africa region.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Ship to/from Somalia?
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Contact our Somalia team today for personalized logistics solutions.
            </p>
