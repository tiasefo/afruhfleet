        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-primary-foreground/80">
              {services.map((s) => (
                <li key={s.title}>
                  <Link href={`${base}#services`} className="hover:text-accent">
                    {s.title}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-primary-foreground/80">
              <li><Link href={`${base}/about`} className="hover:text-accent">About Us</Link></li>
              <li><Link href={`${base}#track`} className="hover:text-accent">Track a Package</Link></li>
              <li><Link href={`${base}#notices`} className="hover:text-accent">Warehouse Notices</Link></li>
              <li><Link href={`${base}#payments`} className="hover:text-accent">Bank Payments</Link></li>
              <li><Link href={`${base}/support`} className="hover:text-accent">Support Ticket</Link></li>
              <li><Link href={`${base}/privacy`} className="hover:text-accent">Privacy Policy</Link></li>
              <li><Link href={`${base}/cookies`} className="hover:text-accent">Cookies Policy</Link></li>
            </ul>
          </div>
