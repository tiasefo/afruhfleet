...
class AdminSettings(BaseSettings):
    ...
    app_name: str = Field(default="Afruheritage Sentinel", alias="ADMIN_APP_NAME")
    app_env: str = Field(default="production", alias="ADMIN_APP_ENV")
    secret_key: str = Field(default="sentinel-dev-key-change-in-production", alias="ADMIN_SECRET_KEY")
    access_token_expire_minutes: int = Field(default=120, alias="ADMIN_ACCESS_TOKEN_EXPIRE_MINUTES")
    database_url: str = Field(default="postgresql+psycopg2://afruheritage:afruheritage@localhost:5432/afruheritage", alias="ADMIN_DATABASE_URL")
